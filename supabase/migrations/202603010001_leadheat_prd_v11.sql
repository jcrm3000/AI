...
create table if not exists public.grid_tiles (
  ...
  centroid_lat double precision generated always as ((min_lat + max_lat) / 2.0) stored,
  centroid_lng double precision generated always as ((min_lng + max_lng) / 2.0) stored,
